...
class _PumpingHeartState extends State<PumpingHeart>
  ...
  void initState() {
    ...
    _controller = (widget.controller)..repeat();
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(text ?? 'Please wait...',
                                ...
                                style: TextStyle(color: PRIMARAY, fontSize: 14))
                          ],
                        ),
                      ),
                    ],
  ...
  itemBuilder: (BuildContext context, int index) {
    return DecoratedBox(
      decoration: BoxDecoration(
        color: index.isEven ? WHITE : PRIMARAY,
      ),
    );
  },
);
...
Widget buildShimmer(count) {
  return Shimmer.fromColors(
    baseColor: PRIMARAY.withOpacity(0.3),
...
Widget buildLoadingContainer() {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      color: PRIMARAY.withOpacity(0.1),
    ),
    child: Padding(
